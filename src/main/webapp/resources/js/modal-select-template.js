//Tuannh8_add modal select invoice template
jQuery(document).ready(function ($) {
    ...
    if (cartWrapper.length > 0) {
        ...
        var undoTimeoutId;
        //lay trang thai item
        var sizeItem = document.getElementsByClassName('product').length;
        if (sizeItem > 0) {
            cartCount.find('li').eq(0).text(sizeItem);
